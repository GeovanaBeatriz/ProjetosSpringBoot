package com.geovanabeatriz.course.config;
...
import com.geovanabeatriz.course.entities.Payment;
import com.geovanabeatriz.course.entities.Product;
import com.geovanabeatriz.course.entities.User;
import com.geovanabeatriz.course.entities.enums.OrderStatus;
import com.geovanabeatriz.course.repositories.CategoryRepository;
import com.geovanabeatriz.course.repositories.OrderItemRepository;
import com.geovanabeatriz.course.repositories.OrderRepository;
import com.geovanabeatriz.course.repositories.ProductRepository;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		p1.getCategories().add(cat2); //Associação entre objetos (Muitos para muitos)
